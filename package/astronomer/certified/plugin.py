...
class AstronomerCertifiedPlugin(AirflowPlugin):
    ...
    def start_update_thread(cls):
        from astronomer.version_check.models import AstronomerVersionCheck
        from astronomer.version_check.update_checks import CheckThread
    ...
    def create_db_tables(cls):
        from astronomer.version_check.models import AstronomerAvailableVersion, AstronomerVersionCheck
