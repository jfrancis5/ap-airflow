from astronomer.version_check.models import AstronomerVersionCheck, AstronomerAvailableVersion
from astronomer.version_check.update_checks import CheckThread, UpdateAvailableBlueprint
...
@mock.patch('astronomer.version_check.update_checks.get_ac_version')
